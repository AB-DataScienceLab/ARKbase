...
<head>
    ...
    <title>Drug-Target Insights for Streptococcus_pneumoniae</title>
...
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1>Drug-Target Interactions for <em> Streptococcus pneumoniae<em></h1>
                    <br>
...
<!--                            Graphical Abstract Placeholder Area-->
    ...
    <script>
        ...
        const DATA_FETCH_URL = 'fetch_dti_sp.php'; // UPDATED FILENAME
        const GO_FETCH_URL = 'fetch_go_sp.php'; // For all GO data
