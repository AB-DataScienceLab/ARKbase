...
$columns = ['Isolate_acession', 'Antibiotic', 'Antibiotic_Class', 'Phenotype'];
...
if (!empty($searchValue)) {
    $whereClauses[] = "(Isolate_acession LIKE ? OR Antibiotic LIKE ? OR Antibiotic_Class LIKE ? OR Phenotype LIKE ?)";
...
$dataQuery = "SELECT Isolate_acession, Antibiotic, Antibiotic_Class, Phenotype $baseQuery $whereSqlForFiltered  $limitSql";
