...
<div class="page-content-wrapper container">
    ...
    <div class="tabs">
        ...
        <a class="tab-button" href="genome_Haemophilus_influenzae.php">Genomes</a>
<!--        <button class="tab-button" onclick="showTab('genes-proteins')">Genes/Proteins</button>-->
        <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/struct_arg.php?pathogen=h_influenzae">Structural Annotation</a>
       
        <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/ppi_viewer.php?table=ppi_central&records=25&filter_pathogen=Haemophilus_influenzae&filter_protien1_id=&filter_bcq=&filter_dcq=&filter_ccq=&filter_COG_category=">PPI</a>
      <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/drug_targets.php?pathogen=h_influenzae">Drug Targets</a>
                ...
                <div class="left-section">
                    ...
                    <div class="card-row" style="display: flex; gap: 20px; flex-wrap: wrap;">
                        <div class="card" style="flex: 1;">
                            ...
                            <div class="chart-container" style="height: 400px;">
                                <iframe src="/anshu/arkbase/data/COG_plots_all_15/COG_distribution_horizontal_final_HI.html" 
                    ...
                    <div class="card full-width-card">
                        ...
                        <div class="image-container">
                            <img src="images/vfs/hinfluenzae_1.png" alt="Genome Classification" style="max-width: 100%; height:auto;">
                        </div>
                    </div>
...
<div class="card full-width-card">
    ...
    <div class="circos-container">
        <img src="images/Circos_static/H_influenzae_circos_static.png" 
             alt="Circos Plot" 
