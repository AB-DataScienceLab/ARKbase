...
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1>Drug-Target Interactions for <em> Mycobacterium_tuberculosis<em></h1>
                    <br>
...
<!--            <p class="mb-1">ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© 2024 Bioinformatics Research Institute. This database is for research purposes only.</p>-->
...
<!--    </footer>-->
    ...
    <script>
        ...
        const DATA_FETCH_URL = 'fetch_dti_mt.php'; // UPDATED FILENAME
        const GO_FETCH_URL = 'fetch_go_mt.php'; // For all GO data
