...
<div class="page-content-wrapper container">
    ...
    <div class="tabs">
        ...
        <a class="tab-button" href="genome_Klebsiella_pneumoniae.php">Genomes</a>
<!--        <button class="tab-button" onclick="showTab('genes-proteins')">Genes/Proteins</button>-->
       <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/struct_arg.php?pathogen=k_pneumoniae">Structural Annotation</a>
       
        <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/ppi_viewer.php?table=ppi_central&records=25&filter_pathogen=Klebsiella_pneumoniae&filter_protein1_id=&filter_bcq=&filter_ccq=&filter_dcq=&filter_COG_category=">PPI</a>
      <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/drug_targets.php?pathogen=k_pneumoniae">Drug Targets</a>
    ...
    <div class="content">
                ...
                <div class="left-section">
                    ...
                    <div class="card-row" style="display: flex; gap: 20px; flex-wrap: wrap;">
                        <div class="card" style="flex: 1;">
                            ...
                            <div class="chart-container" style="height: 400px;">
                                <iframe src="/anshu/arkbase/data/COG_plots_all_15/COG_distribution_horizontal_final_KP.html" 
                    ...
                    <div class="card full-width-card">
                        ...
                        <div class="image-container">
                            <img src="images/Drug_resistance_profile/KP.png" alt="Genome Classification" style="max-width: 100%; height:auto;">
                        </div>
                    </div>
        ...
        <img src="images/Ref_RGI_graphs/K_pneumoniae_rgi.jpg" 
             alt="Circos Plot" 
...
<div class="card full-width-card">
    ...
    <div class="circos-container">
        <img src="images/Circos_static/K_pneumoniae_circos_static.png" 
             alt="Circos Plot" 
             class="circos-zoomable" 
             id="circosImage">
    </div>
