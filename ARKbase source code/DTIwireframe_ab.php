...
<head>
    ...
    <title>Drug-Target Insights for Acinetobacter baumannii</title>
...
<body>
    ...
    <br>
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1>Drug-Target Interactions for <em> Acinetobacter baumannii</em> </h1>
...
<br><br>
    ...
    <script>
        ...
        const DATA_FETCH_URL = 'fetch_dti_ab.php'; // Make sure this path is correct
             ...
             if (dataToRender.length === 0) {
                 ...
                 if (document.getElementById('searchInput').value) {
                     message = 'No results found on this page for your search term.';
                      ...
                      message = 'No data found for Acinetobacter baumannii in the database.';
                 }
