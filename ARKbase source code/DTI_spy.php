...
<head>
    ...
    <title>Drug-Target Insights for Streptococcus pyogenes</title>
...
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1>Drug-Target Interactions for <em> Streptococcus pyogenes<em></h1>
                    <br>
...
<!--    </footer>-->
    ...
    <script>
        ...
        const DATA_FETCH_URL = 'fetch_dti_spy.php'; // UPDATED FILENAME
        const GO_FETCH_URL = 'fetch_go_spy.php'; // For all GO data
