...
<div class="page-content-wrapper container">
    ...
    <div class="tabs">
        ...
        <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/struct_arg.php?pathogen=s_flexneri">Structural Annotation</a>
        <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/ppi_viewer.php?table=ppi_central&records=25&filter_pathogen=Shigella_flexneri&filter_protien1_id=&filter_bcq=&filter_dcq=&filter_ccq=&filter_COG_category=">PPI</a>
        <a class="tab-button" href="https://datascience.imtech.res.in/anshu/arkbase/drug_targets.php?pathogen=s_flexneri">Drug Targets</a>
    </div>
                ...
                <div class="left-section">
                    ...
                    <div class="card full-width-card">
                        ...
                        <div class="image-container">
                            <img src="images/Drug_resistance_profile/SF.png" alt="Genome Classification" style="max-width: 100%; height:auto;">
                        </div>
                    </div>
                </div>
                ...
                <div class="right-section">
                    ...
                    <div class="card tabular-style">
                       ...
                       <div class="circos-container">
                            <img src="images/Ref_RGI_graphs/S_flexeneri_rgi.jpg" alt="Circos Plot" class="circos-zoomable">
                        </div>
                    </div>
                    ...
                    <div class="card full-width-card">
                        ...
                        <div class="circos-container">
                            <img src="images/Circos_static/S_flexneri_circos_static.png" alt="Circos Plot" class="circos-zoomable">
                        </div>
                    </div>
                </div>
            </div> <!-- dashboard-grid -->
