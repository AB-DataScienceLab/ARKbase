...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['contribution_form_submit'])) {
    ...
    if (isset($_FILES['c_file']) && $_FILES['c_file']['error'] == UPLOAD_ERR_OK) {
        ...
        if ($_FILES['c_file']['size'] > $max_file_size) {
            $errors[] = 'File is too large (max 20 MB). For larger datasets, please contact us directly at <a href="mailto:arkbase2025@gmail.com">arkbase2025@gmail.com</a>.';
        } else {
            $file_uploaded = true;
        }

    } elseif (isset($_FILES['c_file']) && $_FILES['c_file']['error'] != UPLOAD_ERR_NO_FILE) {
    ...
    if (empty($errors)) {
        if (class_exists('PHPMailer\PHPMailer\PHPMailer')) {
            ...
            try {
                ...
                // Attach file if it's valid and uploaded
                if ($file_uploaded) {
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- =========== RIGHT COLUMN: OUR TEAM (MANUALLY ORDERED) =========== -->
        <div class="col-lg-6">
            <div class="container team-section">
                <h1 class="section-title">Our Team</h1>
                <div class="row justify-content-center">
                    <!-- Row 1 -->
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/simran.jpg" alt="Simran Gambhir"><h3><a href="#">Simran Gambhir</a></h3><p class="title">Project Associate I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/simran-gambhir-75059a28a/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/spd.jpg" alt="Shweta Pandey"><h3><a href="#">Shweta Pandey</a></h3><p class="title">Senior Research Fellow</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/shwdey/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/harsh.jpeg" alt="Harsh Bajetha"><h3><a href="#">Harsh Bajetha</a></h3><p class="title">Project Associate I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/harshbajetha/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/jasleen.jpg" alt="Jasleen Kaur"><h3><a href="#">Jasleen Kaur</a></h3><p class="title">Project Candidate</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/jasleen-kaur-ba9241318/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <!-- Row 2 -->
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/ankita.jpg" alt="Ankita Das"><h3><a href="#">Ankita Das</a></h3><p class="title">Project Associate I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/ankita-das-34ba311b4/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/pranav.jpg" alt="Pranavathiyani G."><h3><a href="#">Dr.Pranavathiyani G.</a></h3><p class="title">Project Scientist I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/pranavathiyani/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/rupali.jpg" alt="Rupali Aggrawal"><h3><a href="#">Rupali Aggrawal</a></h3><p class="title">Dissertation Student</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/rupali-aggarwal-43949431a/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/upasana.jpg" alt="Upasana Maity"><h3><a href="#">Upasana Maity</a></h3><p class="title">Project Associate II</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/umaity/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <!-- Row 3 -->
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/suhani .jpg" alt="Suhani Dange"><h3><a href="#">Suhani Dange</a></h3><p class="title">Project Associate I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/suhani-dange-aa570a1a3/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/vipin.jpeg" alt="Vipin Singh"><h3><a href="#">Dr.Vipin Singh</a></h3><p class="title">Independent Researcher</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/dr-vipin-singh-a9581137/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/mayur.jpg" alt="Mayur Zarkar"><h3><a href="#">Mayur Zarkar</a></h3><p class="title">Project Associate I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/mayur-zarkar-3675832b2/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/raghav.jpg" alt="Raghav Sankhdher"><h3><a href="#">Raghav Sankhdher</a></h3><p class="title">Sr. Project Associate</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/raghav-sankhdher-058aa31a/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <!-- Row 4 -->
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/dr_bhupender.png" alt="Bhupender Singh"><h3><a href="#">Dr.Bhupender Singh</a></h3><p class="title">Project Scientist I</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/brshcbio/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/shivani.jpg" alt="Shivani Seth"><h3><a href="#">Shivani Seth</a></h3><p class="title">Junior Research Fellow</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/shivani-seth-b2b4112bb/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                    <div class="col-lg-3 col-md-6 col-6 mb-4"><div class="contact-card"><img src="photos/dr_anshu.png" alt="Anshu Bhardwaj"><h3><a href="#">Dr.Anshu Bhardwaj</a></h3><p class="title">Project PI</p><p class="affiliation">CSIR-IMTech</p><a href="https://www.linkedin.com/in/anshu-bhardwaj-09b8495b/" class="linkedin-btn" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a></div></div>
                </div>
            </div>
        </div>
