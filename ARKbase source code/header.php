...
<head>
   ...
   <script type="text/javascript" language="javascript" src="/anshu/arkbase/structure_search/jsme/jsme.nocache.js"></script>
...
<style>
/* Rule is moved to bottom for better organization */
.logo img {
    max-width: 100%;
    height: auto;
}
        ...
        .arkbase-header {
            ...
            /* MODIFICATION 3: Increased padding for more vertical space */
            padding: 25px 0; 
        }
        ...
        /* MODIFICATION 2A: Increased title font size */
        .arkbase-title h1 {
        ...
        /* MODIFICATION 2B: Increased subtitle font size */
        .arkbase-title h2 {
            color: var(--arkbase-primary);
            font-weight: 600;
        ...
        /* ========== NEW/ADJUSTED STYLE START ========== */
        /* This highlights the parent dropdown item when hovering to show the submenu */
        ...
        /* MODIFICATION 1: Increased logo height */
        .logo img {
        ...
        /* REMOVED: .navbar-nav .nav-link.active styles */
        /* This was causing the highlight effect on selected navbar items */

    </style>
<body>
    <!-- Header -->
    <header class="arkbase-header">
        <!-- MODIFICATION: Changed .container to .container-fluid and added padding -->
        <div class="container-fluid px-4">
            <!-- The class names on this row are fine, its parent controls the width -->
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/faq.php">FAQs & Help</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#"><em>Acinetobacter baumannii</em></a>
                                <ul class="dropdown-menu submenu">
                                    <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                    <li><a class="dropdown-item" href="curated_genome.php?pathogen=Acinetobacter baumannii">Curated Genome</a></li>
                                </ul>
                            </li>
                            <!-- Klebsiella pneumoniae -->
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#"><em>Klebsiella pneumoniae</em></a>
                                <ul class="dropdown-menu submenu">
                                    <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                    <li><a class="dropdown-item" href="curated_genome.php?pathogen=Klebsiella pneumoniae">Curated Genome</a></li>
                                </ul>
                            </li>
                            <!-- Escherichia coli -->
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#"><em>Escherichia coli</em></a>
                                <ul class="dropdown-menu submenu">
                                    <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                    <li><a class="dropdown-item" href="curated_genome.php?pathogen=Escherichia coli">Curated Genome</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dti-view-all-container">
                                ...
                                <ul class="dti-extra-items">
                                    <!-- Shigella flexneri -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Shigella flexneri</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Shigella flexneri">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Shigella sonnei -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Shigella sonnei</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Shigella sonnei">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Enterococcus faecium -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Enterococcus faecium</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Enterococcus faecium">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Pseudomonas aeruginosa -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Pseudomonas aeruginosa</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Pseudomonas aeruginosa">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Salmonella enterica -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Salmonella enterica</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Salmonella enterica">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Neisseria gonorrhoeae -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Neisseria gonorrhoeae</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Neisseria gonorrhoeae">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Staphylococcus aureus -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Staphylococcus aureus</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Staphylococcus aureus">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Streptococcus pyogenes -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Streptococcus pyogenes</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Streptococcus pyogenes">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Streptococcus pneumoniae -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Streptococcus pneumoniae</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Streptococcus pneumoniae">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Haemophilus influenzae -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Haemophilus influenzae</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Haemophilus influenzae">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                    <!-- Streptococcus agalactiae -->
                                    <li class="dropdown-submenu">
                                        <a class="dropdown-item dropdown-toggle" href="#"><em>Streptococcus agalactiae</em></a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="dropdown-item" href="#">Reference Genome</a></li>
                                            <li><a class="dropdown-item" href="curated_genome.php?pathogen=Streptococcus agalactiae">Curated Genome</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dti-view-all-container">
                                ...
                                <ul class="dti-extra-items">
                                    ...
                                    <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/DTI.php?pathogen=Pseudomonas_aeruginosa"><em>Pseudomonas aeruginosa</em></a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/known_antibiotics.php">Known Antibiotics</a></li>
                            <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/structure_search/tool.php">Structure Search</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/abau-browser/?session=local-nyH8-KvS1HjTM08cjqZrV"><em>Acinetobacter baumannii</em></a></li>
                            <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/#"><em>Klebsiella pneumoniae</em></a></li>
                            <li><a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/ecoli-browser/?session=local-W69TdAOneRQXCfLKwe09d"><em>Escherichia coli</em></a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li class="dti-view-all-container">
                                <a class="dropdown-item text-center dti-view-all-trigger" href="#">
                                    View All Pathogens <i class="bi bi-chevron-down"></i>
...
<!--                        <span class="insight-label">INSIGHT MODULE</span>-->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                             ...
                             <li>
                                <a class="dropdown-item" href="https://datascience.imtech.res.in/anshu/arkbase/queryb.php">Advanced Search</a>
                            </li>
                        </ul>
                    </li>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Loop through each link to check if its href matches the current URL
    navLinks.forEach(function(link) {
        if (link.href === currentUrl) {
            link.classList.add('active');

            // If the link is inside a dropdown, also highlight the main dropdown toggle
